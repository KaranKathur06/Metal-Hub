...
const CAPABILITIES = [
  ...
  { label: 'Wire Drawing', value: 'wire-drawing' },
] as const;
          ...
          <nav className="hidden items-center lg:flex">
            <ul className="flex items-center gap-9">
              <li>
                <Link
                  href="/"
                  className={cn(NAV_LINK_CLASS, mounted && pathname === '/' ? 'text-slate-900' : 'text-slate-700')}
                >
                  Home
                </Link>
              </li>
              ...
              <li>
                <Link
                  ...
                  className={cn(
                    NAV_LINK_CLASS,
                    mounted && pathname === '/marketplace' ? 'text-slate-900' : 'text-slate-700',
                  )}
                >
                  Marketplace
                </Link>
              ...
              <li className="group relative">
                ...
                <div className="pointer-events-auto absolute left-0 right-0 top-full h-8" />
                <div className="pointer-events-none invisible fixed left-0 right-0 top-20 z-50 border-b bg-white opacity-0 shadow-md transition-opacity duration-200 group-hover:pointer-events-auto group-hover:visible group-hover:opacity-100">
          ...
          {isAuthenticated ? (
            ...
            <div className="hidden items-center gap-2 md:flex">
              ...
              <Link href="/post-requirement">
                <Button
                  size="sm"
                  className="ml-2 border-none bg-gradient-to-br from-[#1e3a8a] to-[#3b82f6] font-bold text-white shadow-[0_4px_14px_rgba(59,130,246,0.3)] transition-all hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(59,130,246,0.4)]"
                >
                  Post Requirement
                </Button>
              </Link>
